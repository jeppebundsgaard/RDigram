#' @title Physical Activities of Daily Living
#' @description Measure of functional ability of healthy elderly (Avlund et.al., 1993)
#' @docType data
#' @keywords datasets
#' @name ADLtired
#' @usage data(ADLtired)
#' @return ADLtired is an object of class digram.object.
#' @format A data frame with 734 rows and 97 variables of which 19 are used.
...
#' }
#' @source The \code{ADLtired} data were obtained from
